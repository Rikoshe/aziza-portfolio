<?php
 ...
 ?>
        ...
        <div id="clearThis"></div>
         <h2 class="title darkP text-white text-center"><i class="fas fa-hiking"></i>Mon parcours</h2>
          <hr>
            <section class="container">
              <figure>
                <img class="photo" src="img/Aaziza(1).jpg" alt="">
              </figure>
                <p class=" paragra">Bonjour, je m'appelle Aaziza Pollet et je suis developpeuse web junior PHP Symfony. J'ai choisi ce domaine, car il m'offre... </p>
            </section>
            <section class="container lightBac">
              <h2>Voir mes résultat en athlétisme :</h2>
              <ul>
